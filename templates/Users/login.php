  ...
  <div class="card  my-3 card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <div class="input-group mb-3">
        <?= $this->Form->email('email', ['class' => 'form-control', 'placeholder' => 'อีเมลล์']) ?>
      ...
      <div class="row m-0 p-0">
        ...
        <div class="col-12 mt-4 p-0">
          <?= $this->Form->button('เข้าสู่ระบบ', ['class' => "btn btn-primary btn-block", "id" => 'login']); ?>
        </div>
      </div>
...
<script>
  ...
  $('#login').click(function() {
    let Cart_storage = localStorage.getItem("orders_token");
    if (Cart_storage !== null) {
      $('#cart_storage').val(Cart_storage)
    } else {
      $('#cart_storage').val('')
    }
  })
