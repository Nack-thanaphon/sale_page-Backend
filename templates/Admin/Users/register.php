...
<div class="login-box my-5 mx-auto">
    <div class="card  my-3 card-outline card-primary">
        <div class="card-header text-start my-2 text-sm-center">
            <h2 class="m-0 p-0">สมัครสมาชิก</h2>
        ...
        <div class="card-body">
            ...
            <div class="input-group mb-3">
                <?= $this->Form->input('email', ['class' => 'form-control', 'placeholder' => 'อีเมลล์ที่ใช้งาน']) ?>
                <div class="input-group-append">
                    <div class="input-group-text">
            ...
            <div class="row m-0 p-0">
                <div class="col-12 mt-4 p-0">
                    <?= $this->Form->button('สมัครสมาชิก', ['class' => "btn btn-primary btn-block"]); ?>
                </div>
            </div>
